...
public class PickServlet extends HttpServlet{
    ...
    public JSONArray getCommodityClassfication(){
        ...
        ArrayList<CommodityclassficationEntity> commodityClassficationArrayList= (ArrayList)commodityClassficationService.getallCommodityClassfication();
    ...
    public JSONArray getCommodity(){
        ...
        ArrayList<CommodityEntity> commodityArrayList=(ArrayList)commodityService.findallCommodity();
